const Footer = () => {
	return (
		<footer className="mx-auto mb-6 mt-8 w-full max-w-7xl px-4 sm:px-8 lg:px-12">
				...
				<div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
					...
					<div className="flex flex-col gap-6 sm:flex-row sm:gap-10">
						<ul>
							...
							<li className="text-dark-200/60 hover:text-dark-200 ">
						...
						<ul>
							...
							<li className="text-dark-200/60 hover:text-dark-200 ">
								<a
									href="htpps://www.linkedin.com/in/jasondb001"
									rel="noopener noreferrer"
									target="_blank"
									className="transition hover:text-blue-600"
								>
